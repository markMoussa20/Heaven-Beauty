...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[90] grid h-[52px] w-[52px] place-items-center rounded-full bg-[#25d366] text-white shadow-[0_10px_28px_rgba(37,211,102,0.3)] transition duration-300 hover:-translate-y-1 hover:scale-105"
      href={whatsappUrl}
      rel="noreferrer"
      target="_blank"
    >
